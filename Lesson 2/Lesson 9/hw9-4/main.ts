// #Kx1xgoKy8
let coursesAndDurationArray9:{title:string, monthDuration:number}[] = [
...
for(const course of coursesAndDurationArray9) {
    ...
    const courseTitle:HTMLHeadingElement = document.createElement('h1');
    courseTitle.classList.add('heading');
    courseTitle.innerText = course.title;

    const courseDescr:HTMLParagraphElement = document.createElement('p');
